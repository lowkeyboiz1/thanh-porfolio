...
import { CenteredPixelTransition, Menu } from '@/components/Menu'
...
export default function Home() {
  ...
  return (
    <div id='home' className={`flex flex-col gap-4 bg-black text-white ${isCursorVisible ? 'cursor-none' : 'cursor-default'} `}>
      <Menu />
